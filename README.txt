...
#	- Add a method for user to set persistent pw_key for
#	encrypting and decrypting session keys needed to decrypt
#	saved passwords - save persistent key to new table?
...
#   - Terminal app to be saved as SPM.py, execute at CLI with
#	"python SPM.py"
